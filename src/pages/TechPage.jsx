...
const PROJECTS = [
  { name: 'Dear Stranger', subtitle: 'Personal Project', desc: `A community storytelling platform where users share travel memories as digital postcards — a photo paired with personal reflections, left for strangers to discover. Rather than a typical travel feed, it reframes user-generated content as intimate, anonymous correspondence: browse "letters" from people who've visited places you care about, and see them through a stranger's eyes.`, stack: 'Ejs - Psql - Railway', github: 'https://github.com/cooleditingx/Dear-Stranger', website: 'https://dear-stranger-production.up.railway.app/'},
